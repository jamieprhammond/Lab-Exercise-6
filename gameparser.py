...
skip_words = ['a', 'about', 'all', 'an', 'another', 'any', 'around', 'at',
              ...
              'wish', 'with', 'would', 'you', 'your', 'yours', 'thee',
              'thy', 'thou', 'ye', 'now', 'the', 'please', 'with', 'my',
              'i', 'would', 'like', 'to', 'here', 'wish', 'this', 'how', 'about',
              'through', 'that']
...
def normalise_input(user_input):
    ...
    no_punct = remove_punct(user_input).lower() # Remove punctuation and convert to lower case

    words = no_punct.split() # Split the string into a list of words

    important_words = filter_words(words, skip_words) # Filter out unimportant words

    return important_words # Return the list of important words
